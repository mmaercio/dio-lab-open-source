...
| 'docs'    | Altera a documentacao do projeto. Ex .: README, comentarios no codigo.
| 'style'   | Realiza mudanças na aparência, sem alterar a funcionalidade.
| 'refactor'| Realiza mudanças no codigo que nao alteram a funcionalidade.
| 'test     | Adiciona ou modifica testes no projeto.

## Referências
- [ANGULAR. Contributing to Angular](https://github.com/angular/angular/blob/22b96b9/CONTRIBUTING.md)
- [CONVENTIONAL COMMITS. Summary](https://www.conventionalcommits.org/en/v1.0.0/)
- [GITHUB, Configurar diretrizes para os contribuidores do repositorio](https://docs.github.com/pt/communities/setting-up-your-project-for-healthy-contributions/se
